...
abstract class AppLocalizations {
  ...
  /// No description provided for @simplefirebaseChat.
  ///
  /// In en, this message translates to:
  /// **'Simple FirebaseChat'**
  String get simplefirebaseChat;

  /// No description provided for @firebasedynamicLinking.
  ///
  /// In en, this message translates to:
  /// **'Firebase DynamicLinking'**
  String get firebasedynamicLinking;
  ...
  /// No description provided for @readandwritefile.
  ///
  /// In en, this message translates to:
  /// **'ReadAndWriteFile'**
  String get readandwritefile;

  /// No description provided for @getpost.
  ///
  /// In en, this message translates to:
  /// **'Get Post'**
  String get getpost;
