...
import '../Material_Search/material_search.dart';

class Material_Route extends StatefulWidget {
  @override
  _MyHomePageState createState() => new _MyHomePageState();
}

class _MyHomePageState extends State<Material_Route> {
  final _names = [
    'Igor Minar',
    'Brad Green',
    'Dave Geddes',
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text("Material Search",style: TextStyle(color: Colors.black)),backgroundColor: Colors.white,leading: BackButton(
          color: Colors.black
      ),
        actions: <Widget>[
          new IconButton(
