...
class Video1 extends StatefulWidget {
  @override
  _Video1_State createState() => _Video1_State();
}

class _Video1_State extends State<Video1> {
  List listCat;
  bool loading = true;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: new Text(
            "Video Style 1", style: TextStyle(color: Colors.black),),
            ...
            return GestureDetector(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => new Video_Des_1(
                              link: listCat[index]["link"],
                              title: listCat[index]["title"],
                              desc: listCat[index]["description"],
                            )));
              },
            );
          }),
