...
class _E_Commerce_1State extends State<E_Commerce_1> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: new Text('E-Commerce Style 1',style: TextStyle(color: Colors.black)),backgroundColor: Colors.white,leading: BackButton(
            color: Colors.black
        ),),
        drawer: new Drawer(),
        body: new ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return new GestureDetector(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Text('\$${listCat[index].price}'),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                              ...
                              Align(
                                  ...
                                  child: new OutlinedButton(
                                    style: OutlinedButton.styleFrom(padding: EdgeInsets.all(10), side: BorderSide(color: Colors.black), shape: new RoundedRectangleBorder(borderRadius: new BorderRadius.circular(30.0))),
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => Detail_Ecmmerce_1(index: index, model: listCat[index])));
                },
              );
            }));
  }
