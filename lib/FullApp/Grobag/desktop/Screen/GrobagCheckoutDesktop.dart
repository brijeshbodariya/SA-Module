...
import 'package:smartkit/FullApp/Grobag/desktop/Screen/GrobagAddAddressDesktop.dart';

import 'GrobagOrderSuccessDesktop.dart';

class GrobagCheckoutDesktop extends StatefulWidget {
  @override
  _GrobagCheckoutDesktopState createState() => _GrobagCheckoutDesktopState();
}

class _GrobagCheckoutDesktopState extends State<GrobagCheckoutDesktop> {
          ...
          child: Column(
            children: [
              ...
              CupertinoButton(
                ...
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => OrderSuccessDesktop()));
                },
              ),
            ],
          ),
            ...
            title: Row(
              children: [
                ...
                InkWell(
                  ...
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => GrobagAddAddressDesktop()));
                  },
                ),
              ],
            )),
