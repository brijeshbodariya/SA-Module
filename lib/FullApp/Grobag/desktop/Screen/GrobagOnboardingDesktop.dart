...
import 'GrobagSignupMainDesktop.dart';

class GrobagOnbordingDesktop extends StatefulWidget {
  GrobagOnbordingDesktop({Key key}) : super(key: key);

  @override
  _GrobagOnbordingDesktopState createState() => _GrobagOnbordingDesktopState();
}

class _GrobagOnbordingDesktopState extends State<GrobagOnbordingDesktop> {
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center, children: [
                  Padding(
                    ...
                    child: Text(slideList[currentIndex].title, style: Theme.of(context).textTheme.headline5.copyWith(color: fontColor, fontSize: 50)),
                  ),
                  Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 20.0),
                      child: Container(
                        padding: EdgeInsets.only(top: height <= 640.0 ? 10.0 : 20.0, left: 10.0, right: 10.0),
                        child: Text(slideList[currentIndex].description, textAlign: TextAlign.center, style: Theme.of(context).textTheme.subtitle1.copyWith(color: fontLight, fontWeight: FontWeight.normal, fontSize: 30)),
                      )),
                  SizedBox(height: 50),
                  Row(
        ...
        onPressed: () {
          if (currentIndex == 0) {
            ...
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (BuildContext context) => GrobagSignupMainDesktop(),
              ),
            );
          }
        },
