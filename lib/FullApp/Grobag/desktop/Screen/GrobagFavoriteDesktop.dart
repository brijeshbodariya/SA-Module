...
class GrobagFavoriteDesktop extends StatefulWidget {
  @override
  _GrobagFavoriteDesktopState createState() => _GrobagFavoriteDesktopState();
}

class _GrobagFavoriteDesktopState extends State<GrobagFavoriteDesktop> {
  List favList = [
