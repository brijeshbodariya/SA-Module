...
import 'GrobagCartDesktop.dart';

class GrobagProductDetailDesktop extends StatefulWidget {
  final int pos;

  const GrobagProductDetailDesktop({Key key, this.pos}) : super(key: key);

  @override
  _GrobagProductDetailDesktopState createState() => _GrobagProductDetailDesktopState();
}

class _GrobagProductDetailDesktopState extends State<GrobagProductDetailDesktop> {
  int _curSlider = 0;
  List<Widget> pages = [];
  List itemList = [
    {
              ...
              child: Column(
                ...
                children: [
                  Row(children: [
                    ...
                    Expanded(child: Column(children: [_offRow(), Align(alignment: Alignment.topLeft, child: (_title())), _price(), _proDesc()]))
                  ]),
                  Divider(),
                  _heading(),
                  _similarItems()
            ...
            children: [
              Container(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => GrobagCartDesktop()));
                  },
                ),
              ),
              Expanded(
