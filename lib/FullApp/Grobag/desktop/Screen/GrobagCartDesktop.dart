...
import 'package:smartkit/FullApp/Grobag/desktop/Screen/GrobagCheckoutDesktop.dart';
import 'package:smartkit/FullApp/Grobag/desktop/Screen/GrobagHomeDesktop.dart';

class GrobagCartDesktop extends StatefulWidget {
  @override
  _GrobagCartDesktopState createState() => _GrobagCartDesktopState();
}

class _GrobagCartDesktopState extends State<GrobagCartDesktop> {
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, mainAxisSize: MainAxisSize.max, children: <Widget>[
                          Padding(
                          ...
                          CupertinoButton(
                            ...
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => GrobagCheckoutDesktop()));
                            },
                          ),
                        ]),
                      ),
  ...
  shopNow() {
    return Padding(
      ...
      child: CupertinoButton(
        ...
        onPressed: () {
          Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (BuildContext context) => GrobagHomeDesktop()), ModalRoute.withName('/'));
        },
      ),
    );
  }
