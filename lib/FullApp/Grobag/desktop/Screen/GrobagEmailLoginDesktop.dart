...
class GrobagEmailLoginDesktop extends StatefulWidget {
  @override
  _GrobagEmailLoginDesktopState createState() => _GrobagEmailLoginDesktopState();
}

class _GrobagEmailLoginDesktopState extends State<GrobagEmailLoginDesktop> {
