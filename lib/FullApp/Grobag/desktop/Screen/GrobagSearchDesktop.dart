...
class GrobagSearchDesktop extends StatefulWidget {
  @override
  _GrobagSearchDesktopState createState() => _GrobagSearchDesktopState();
}

class _GrobagSearchDesktopState extends State<GrobagSearchDesktop> {
  List itemList = [];
  ChoiceChip tagChip;
