...
import 'GrobagOTPTablet.dart';

class GrobagMobInputTablet extends StatefulWidget {
  @override
  _GrobagMobInputTabletState createState() => _GrobagMobInputTabletState();
}

class _GrobagMobInputTabletState extends State<GrobagMobInputTablet> {
  String countrycode;
    ...
    return CupertinoButton(
      ...
      onPressed: () {
        Navigator.push(context,
            new MaterialPageRoute(builder: (context) => GrobagOTPTablet()));
      },
    );
  }
}
