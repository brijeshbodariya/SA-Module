...
import 'package:smartkit/FullApp/Grobag/tablet/Screen/GrobagLoginTablet.dart';
import 'package:smartkit/FullApp/Grobag/tablet/Screen/GrobagSignupTablet.dart';
import 'package:smartkit/SmartkitScreen/Screen/SmartKitHome.dart';

import 'GrobagHomeTablet.dart';

class GrobagSignupMainTablet extends StatefulWidget {
  @override
  _GrobagSignupMainTabletState createState() => _GrobagSignupMainTabletState();
}

class _GrobagSignupMainTabletState extends State<GrobagSignupMainTablet> {
  @override
          ...
          InkWell(
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => GrobagLoginTablet(),
                ));
              },
              child: Text(
                'Login Here',
