...
import 'package:smartkit/FullApp/Grobag/tablet/Screen/GrobagMobInputTablet.dart';

import 'GrobagHomeTablet.dart';

class GrobagSignupTablet extends StatefulWidget {
  @override
  _GrobagSignupTabletState createState() => _GrobagSignupTabletState();
}

class _GrobagSignupTabletState extends State<GrobagSignupTablet> {
  ...
  createbtn() {
    return CupertinoButton(
      ...
      onPressed: () {
        Navigator.push(context, new MaterialPageRoute(builder: (context) => GrobagMobInputTablet()));
      },
    );
  }
}
