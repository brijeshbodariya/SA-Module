...
import 'package:smartkit/FullApp/Grobag/tablet/Screen/GrobagAddAddressTablet.dart';

import 'GrobagOrderSuccessTablet.dart';

class GrobagCheckoutTablet extends StatefulWidget {
  @override
  _GrobagCheckoutTabletState createState() => _GrobagCheckoutTabletState();
}

class _GrobagCheckoutTabletState extends State<GrobagCheckoutTablet> {
      ...
      body: Column(
        children: [
          ...
          CupertinoButton(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => OrderSuccessTablet()));
            },
          ),
        ],
      ),
            ...
            title: Row(
              children: [
                ...
                InkWell(
                  ...
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => GrobagAddAddressTablet()));
                  },
                ),
              ],
            )),
