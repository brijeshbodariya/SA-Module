...
import 'package:smartkit/FullApp/Grobag/tablet/Screen/GrobagEmailLoginTablet.dart';
import 'package:smartkit/FullApp/Grobag/tablet/Screen/GrobagHomeTablet.dart';

import 'GrobagSignupTablet.dart';

class GrobagLoginTablet extends StatefulWidget {
  @override
  _GrobagLoginTabletState createState() => _GrobagLoginTabletState();
}

class _GrobagLoginTabletState extends State<GrobagLoginTablet> {
  @override
          ...
          InkWell(
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => GrobagSignupTablet(),
                ));
              },
              child: Text(
                'Signup Here',
  ...
  signupbtn() {
    return CupertinoButton(
      ...
      onPressed: () {
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => GrobagEmailLoginTablet()));
      },
    );
  }
  ...
  googlebtn() {
    return CupertinoButton(
      ...
      onPressed: () {
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => GrobagHomeTablet()));
      },
    );
  }
