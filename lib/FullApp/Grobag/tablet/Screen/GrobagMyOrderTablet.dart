...
import 'GrobagTrackorderTablet.dart';

class GrobagMyOrderTablet extends StatefulWidget {
  @override
  _GrobagMyOrderTabletState createState() => _GrobagMyOrderTabletState();
}

class _GrobagMyOrderTabletState extends State<GrobagMyOrderTablet> {
  @override
                  ...
                  TextButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => GrobagTrackOrderTablet(
                                  index: index,
                                )),
                      );
                    },
