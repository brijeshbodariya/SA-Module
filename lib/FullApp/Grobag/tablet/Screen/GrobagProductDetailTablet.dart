...
import 'GrobagCartTablet.dart';

class GrobagProductDetailTablet extends StatefulWidget {
  final int pos;

  const GrobagProductDetailTablet({Key key, this.pos}) : super(key: key);

  @override
  _GrobagProductDetailTabletState createState() => _GrobagProductDetailTabletState();
}

class _GrobagProductDetailTabletState extends State<GrobagProductDetailTablet> {
  int _curSlider = 0;
  List<Widget> pages = [];
  List itemList = [
    {
            ...
            children: [
              Container(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => GrobagCartTablet()));
                  },
                ),
              ),
              Expanded(
