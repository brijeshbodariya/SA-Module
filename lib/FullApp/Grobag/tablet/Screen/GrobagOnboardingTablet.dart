...
class GrobagOnbordingTablet extends StatefulWidget {
  GrobagOnbordingTablet({Key key}) : super(key: key);

  @override
  _GrobagOnbordingTabletState createState() => _GrobagOnbordingTabletState();
}

class _GrobagOnbordingTabletState extends State<GrobagOnbordingTablet> {
        ...
        onPressed: () {
          if (currentIndex == 0) {
            ...
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (BuildContext context) => GrobagSignupMainTablet(),
              ),
            );
          }
        },
