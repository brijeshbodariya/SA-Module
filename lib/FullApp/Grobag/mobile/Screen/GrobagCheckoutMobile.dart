...
import 'package:smartkit/FullApp/Grobag/mobile/Screen/GrobagAddAddressMobile.dart';

import 'GrobagOrderSuccessMobile.dart';

class GrobagCheckoutMobile extends StatefulWidget {
  @override
  _GrobagCheckoutMobileState createState() => _GrobagCheckoutMobileState();
}

class _GrobagCheckoutMobileState extends State<GrobagCheckoutMobile> {
      ...
      body: Column(
        children: [
          ...
          CupertinoButton(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => OrderSuccessMobile()));
            },
          ),
        ],
      ),
            ...
            title: Row(
              children: [
                ...
                InkWell(
                  ...
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => GrobagAddAddressMobile()));
                  },
                ),
              ],
            )),
