...
import 'package:smartkit/FullApp/Grobag/mobile/Screen/GrobagAllCatMobile.dart';
import 'package:smartkit/FullApp/Grobag/mobile/Screen/GrobagCartMobile.dart';
import 'package:smartkit/FullApp/Grobag/mobile/Screen/GrobagNotificationMobile.dart';
import 'package:smartkit/FullApp/Grobag/mobile/Screen/GrobagProductDetailMobile.dart';
import 'package:smartkit/FullApp/Grobag/mobile/Screen/GrobagProductListMobile.dart';
import 'package:smartkit/FullApp/Grobag/mobile/Screen/GrobagSearchMobile.dart';
import 'package:smartkit/SmartkitScreen/Screen/SmartKitHome.dart';

import 'GrobagFavoriteMobile.dart';
import 'GrobagMyProfileMobile.dart';

class GrobagHomeMobile extends StatefulWidget {
  @override
  _GrobagHomeMobileState createState() => _GrobagHomeMobileState();
}

class _GrobagHomeMobileState extends State<GrobagHomeMobile> {
  int _curBottom = 0;
  ...
  void initState() {
    ...
    fragments = [
      HomePageMobile(),
      GrobagAllCatMobile(),
      GrobagFavoriteMobile(),
      GrobagMyProfileMobile(),
    ];
  }
            ...
            ? AppBar(
                ...
                actions: [
                  GestureDetector(
                    ...
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => GrobagNotificationMobile()));
                    },
                  ),
                  GestureDetector(
                    child: Padding(
                    ...
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => GrobagCartMobile()));
                    },
                  ),
                ],
              )
        ...
        children: [
          ...
          Expanded(
            child: GestureDetector(
              ...
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => GrobagSearchMobile()));
              },
            ),
          ),
        ],
            ...
            child: InkWell(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => GrobagProductDetailMobile(
                              pos: 0,
                            )));
              },
              child: Column(
