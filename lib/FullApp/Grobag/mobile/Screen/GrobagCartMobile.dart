...
import 'package:smartkit/FullApp/Grobag/mobile/Screen/GrobagCheckoutMobile.dart';
import 'package:smartkit/FullApp/Grobag/mobile/Screen/GrobagHomeMobile.dart';

class GrobagCartMobile extends StatefulWidget {
  @override
  _GrobagCartMobileState createState() => _GrobagCartMobileState();
}

class _GrobagCartMobileState extends State<GrobagCartMobile> {
            ...
            : Column(
                children: <Widget>[
                  ...
                  CupertinoButton(
                    ...
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => GrobagCheckoutMobile()));
                    },
                  ),
                ],
              ));
  ...
  shopNow() {
    return Padding(
      ...
      child: CupertinoButton(
        ...
        onPressed: () {
          Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (BuildContext context) => GrobagHomeMobile()), ModalRoute.withName('/'));
        },
      ),
    );
  }
