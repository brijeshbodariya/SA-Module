...
import 'package:smartkit/FullApp/Grobag/mobile/Screen/GrobagLoginMobile.dart';
import 'package:smartkit/FullApp/Grobag/mobile/Screen/GrobagMyOrderMobile.dart';
import 'package:smartkit/services/auth_service.dart';

class GrobagMyProfileMobile extends StatefulWidget {
  @override
  _GrobagMyProfileMobileState createState() => _GrobagMyProfileMobileState();
}

class _GrobagMyProfileMobileState extends State<GrobagMyProfileMobile> {
  ...
  _myOrder() {
    return Container(
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => GrobagMyOrderMobile()));
        },
      ),
    );
  }
      ...
      child: ListTile(
        ...
        onTap: (){
          ...
          Navigator.of(context).pushReplacement(MaterialPageRoute(
            builder: (context) => GrobagLoginMobile(),
          ));
        },
      ),
    );
