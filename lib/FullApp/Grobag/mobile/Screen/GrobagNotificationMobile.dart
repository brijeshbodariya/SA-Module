...
class GrobagNotificationMobile extends StatefulWidget {
  @override
  _GrobagNotificationMobileState createState() => _GrobagNotificationMobileState();
}

class _GrobagNotificationMobileState extends State<GrobagNotificationMobile> {
  List notiList = [
