...
class GrobagSearchMobile extends StatefulWidget {
  @override
  _GrobagSearchMobileState createState() => _GrobagSearchMobileState();
}

class _GrobagSearchMobileState extends State<GrobagSearchMobile> {
  List itemList = [];
  ChoiceChip tagChip;
