...
import 'GrobagOTPMobile.dart';

class GrobagMobInputMobile extends StatefulWidget {
  @override
  _GrobagMobInputMobileState createState() => _GrobagMobInputMobileState();
}

class _GrobagMobInputMobileState extends State<GrobagMobInputMobile> {
  String countrycode;
      ...
      onPressed: () {
        if(formKey.currentState.validate()){
          Navigator.push(context,
              new MaterialPageRoute(builder: (context) => GrobagOTPMobile(phone: phoneController.text.trim(),)));
        }
      },
    );
  }
