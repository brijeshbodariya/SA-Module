...
import 'package:smartkit/FullApp/Grobag/Screen/GrobagCheckout.dart';
  ...
  shopNow() {
    return Padding(
      ...
      child: CupertinoButton(
        ...
        onPressed: () {
          Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (BuildContext context) => GrobagHome()), ModalRoute.withName('/'));
        },
      ),
    );
  }
