...
import 'package:smartkit/FullApp/Grobag/Screen/GrobagAllCat.dart';
import 'package:smartkit/FullApp/Grobag/Screen/GrobagCart.dart';
import 'package:smartkit/FullApp/Grobag/Screen/GrobagNotification.dart';
import 'package:smartkit/FullApp/Grobag/Screen/GrobagProductDetail.dart';
import 'package:smartkit/FullApp/Grobag/Screen/GrobagProductList.dart';
import 'package:smartkit/FullApp/Grobag/Screen/GrobagSearch.dart';
            ...
            ? AppBar(
                ...
                actions: [
                  GestureDetector(
                    ...
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => GrobagNotification()));
                    },
                  ),
                  GestureDetector(
                    child: Padding(
                    ...
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => GrobagCart()));
                    },
                  ),
                ],
              )
        ...
        children: [
          ...
          Expanded(
            child: GestureDetector(
              ...
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => GrobagSearch()));
              },
            ),
          ),
        ],
