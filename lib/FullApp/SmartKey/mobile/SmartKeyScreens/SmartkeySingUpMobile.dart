...
class SmartKeySingUpMobile extends StatefulWidget {
  SmartKeySingUpMobile({Key key}) : super(key: key);

  @override
  _SmartKeySingUpMobileState createState() => _SmartKeySingUpMobileState();
}

class _SmartKeySingUpMobileState extends State<SmartKeySingUpMobile>
  ...
  void _handleOnTabBackButton() {
    Navigator.pushReplacement(
      context,
      PageRouteBuilder(
          pageBuilder: (context, anim1, anim2) => SmartKeyLoginMobile()),
    );
  }
