...
import 'package:smartkit/FullApp/SmartKey/mobile/SmartKeyScreens/SmartkeySingUpMobile.dart';
...
import 'SmartKeyHomeMobile.dart';

class SmartKeyLoginMobile extends StatefulWidget {
  SmartKeyLoginMobile({Key key}) : super(key: key);

  @override
  _SmartKeyLoginMobileState createState() => _SmartKeyLoginMobileState();
}

class _SmartKeyLoginMobileState extends State<SmartKeyLoginMobile>
          ...
          route: () async {
            ...
            try {
              await authServices.authSignInUser(
                  ...
                  context: context);
              Toast.show("Log In SuccessFully", context,
          ...
          GestureDetector(
            ...
            onTap: () {
              try {
                ...
                authModel.smartKeyFacebookLogin(context);
                EasyLoading.dismiss();
              } catch (e) {
