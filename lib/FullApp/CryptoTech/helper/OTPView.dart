    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
            counterText: "",
            enabledBorder: widget.showFieldAsBox ? OutlineInputBorder(borderSide: BorderSide(width: 1.0, color: widget.boxColor)) : UnderlineInputBorder(borderSide: BorderSide(width: 1.0, color: widget.boxColor)),
            focusedBorder: widget.showFieldAsBox ? OutlineInputBorder(borderSide: BorderSide(width: 2.0, color: widget.boxColor)) : UnderlineInputBorder(borderSide: BorderSide(width: 2.0, color: widget.boxColor))),
