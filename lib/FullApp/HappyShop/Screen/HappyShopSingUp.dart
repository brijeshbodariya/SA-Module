...
class _HappyShopSingUpState extends State<HappyShopSingUp> with TickerProviderStateMixin {
  ...
  Future<void> validatanimations() async {
    ...
    if(_formkey.currentState.validate()){
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => HappyShopMobailVerification(mobileNumber:mobileController.text.trim(),)));
    }
  ...
  setUserName() {
    return Padding(
      ...
      child: TextFormField(
        ...
        validator: (val)=>nameController.text.isEmpty ?"enter name": null,
  ...
  setMobileNo() {
    return Padding(
      ...
      child: TextFormField(
        ...
        validator: (val)=>mobileController.text.isEmpty ?"enter name": null,
        decoration: InputDecoration(
  ...
  setEmail() {
    return Padding(
      ...
      child: TextFormField(
        ...
        validator: (Val)=> emailController.text.isEmpty?"enter email":null,
        decoration: InputDecoration(
  ...
  setPass() {
    return Padding(
      ...
      child: TextFormField(
        ...
        validator: (val)=> passwordController.text.isEmpty?"enter password":null,
        decoration: InputDecoration(
