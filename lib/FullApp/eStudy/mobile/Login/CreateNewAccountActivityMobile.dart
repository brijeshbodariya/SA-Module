...
class CreateNewAccountActivityMobileState extends State<CreateNewAccountActivityMobile> {
            ...
            children: <Widget>[
              ...
              TextButton(
                onPressed: () async {
                  ...
                  // Navigator.push(context, MaterialPageRoute(builder: (_) => LetsGetStartActivityMobile()));
                },
                child: Container(
