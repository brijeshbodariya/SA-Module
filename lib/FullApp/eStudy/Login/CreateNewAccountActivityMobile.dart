...
import 'package:smartkit/FullApp/eStudy/Login/LetsGetStartActivityMobile.dart';

class CreateNewAccountActivityMobile extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new CreateNewAccountActivityMobileState();
  }
}

class CreateNewAccountActivityMobileState
    extends State<CreateNewAccountActivityMobile> {
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextButton(
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (_) => LetsGetStartActivityMobile()));
              },
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Align(
                        alignment: Alignment.center,
                        child: SvgPicture.network("assets/eStudy/continue.svg"))
                  ],
                ),
              ),
            ),
            ...
            Container(
                ...
                alignment: Alignment.center,
                child: Text(StringsRes.Already_Have_Account_lb,
                    textAlign: TextAlign.center,
                    style: TextStyle(
