...
import 'package:smartkit/FullApp/eStudy/Login/CreateNewAccountActivityMobile.dart';
...
import 'package:smartkit/FullApp/eStudy/Login/CreateNewPasswordActivityMobile.dart';
                    ...
                    GestureDetector(
                        onTap: () {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (_) =>
                                      CreateNewPasswordActivityMobile()));
                        },
                        child: Container(
                            margin: EdgeInsets.only(right: 20),
                            height: 61,
                            alignment: Alignment.centerRight,
                            child: Text(StringsRes.Forgot_lb,
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => CreateNewAccountActivityMobile()));
                },
                child: Container(
                    margin: EdgeInsets.only(right: 20),
                    alignment: Alignment.center,
