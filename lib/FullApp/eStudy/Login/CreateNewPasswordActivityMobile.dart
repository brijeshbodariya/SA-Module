...
class CreateNewPasswordActivityMobile extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new CreateNewPasswordActivityMobileState();
  }
}

class CreateNewPasswordActivityMobileState extends State<CreateNewPasswordActivityMobile> {
            ...
            TextButton(
                ...
                child: Container(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      SizedBox(width: 65),
                      Align(alignment: Alignment.center, child: SvgPicture.asset("assets/eStudy/continue.svg"))
                    ]))),
          ],
        ),
      ),
