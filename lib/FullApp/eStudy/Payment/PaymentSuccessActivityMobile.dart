...
class PaymentSuccessActivityMobileState
    extends State<PaymentSuccessActivityMobile> {
  @override
  void initState() {
    super.initState();
    ...
    return Scaffold(
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            SvgPicture.asset("assets/eStudy/payment_success.svg",
            ...
            Container(
              ...
              child: Text(StringsRes.Payment_Detail_lb,
                  textAlign: TextAlign.center,
                  style: TextStyle(
                      fontFamily: 'Nunito-Regular',
                      fontSize: 14,
            ...
            TextButton(
                onPressed: () {
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (_) => HomeActivityMobile()));
                },
                child: Container(
                    margin: EdgeInsets.only(left: 20, right: 20),
                    alignment: Alignment.center,
