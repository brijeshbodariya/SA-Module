...
import 'package:smartkit/FullApp/eStudy/Payment/PaymentSuccessActivityMobile.dart';
...
class PaymentMethodActivityMobile extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new PaymentMethodActivityMobileState();
  }
}

class PaymentMethodActivityMobileState extends State<PaymentMethodActivityMobile> {
  int _currentIndex;
  List<Payment_Model> PaymentList = [
    Payment_Model(
      image: "assets/eStudy/axis.svg",
      bankName: "Axis Bank",
      cardNumber: "**** 4989",
    ),
    Payment_Model(
      image: "assets/eStudy/visa.svg",
      bankName: "HDFC Bank",
      cardNumber: "**** 5987",
    ),
  ];
          ...
          child: Container(
            child: Column(
              ...
              children: <Widget>[
                                ...
                                return Container(
                                    ...
                                    child: RadioListTile(
                                      ...
                                      title: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                        SvgPicture.asset(PaymentList[index].image),
                                        Text(
                ...
                TextButton(
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (_) => PaymentSuccessActivityMobile()));
                    },
                    child: Container(
                      margin: EdgeInsets.only(left: 20, right: 20),
                      alignment: Alignment.center,
