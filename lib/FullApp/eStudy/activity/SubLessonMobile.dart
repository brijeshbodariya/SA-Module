...
import 'package:smartkit/FullApp/eStudy/activity/LessonDetailsMobile.dart';

class SubLessonMobile extends StatefulWidget {
  final int id;
  SubLessonMobile({Key key, this.id}) : super(key: key);
                    ...
                    leading: new CircleAvatar(
                        ...
                        child: ClipOval(
                            child: DesignConfig.DisplayCourseImage(
                                LessonsList[widget.id].image, 100.0, 100.0))),
