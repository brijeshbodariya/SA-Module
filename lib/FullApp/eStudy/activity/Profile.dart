...
class ProfileState extends State<Profile> {
  ...
  var currentDisplayName = FirebaseAuth.instance.currentUser.displayName;
  ...
  Widget _buildFab() {
    ...
    final double defaultTopMargin = MediaQuery.of(context).size.height * .24 - 4.0;
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
                ...
                background: Stack(children: [
                  ...
                  Container(
                    margin: EdgeInsets.only(top: MediaQuery.of(context).size.height * .20, left: MediaQuery.of(context).size.height * .16),
                    alignment: Alignment.bottomLeft,
                    child: Container(
                        margin: EdgeInsets.only(left: 18, right: 20),
                        child: Text.rich(TextSpan(text: currentDisplayName ??StringsRes.appname + "\n", style: TextStyle(color: ColorsRes.white, fontSize: 24), children: <InlineSpan>[
                          TextSpan(
                            text: "\t\t\t" + currentEmail + "\n" ?? StringsRes.User_Email_lb + "\n",
              ...
              TextButton(
                  onPressed: () {
                    authServices.authSignOutUser(context);
                     Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => LoginActivityMobile()));
                  },
                  child: Container(
