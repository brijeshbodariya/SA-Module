...
class BottomPanelMobile extends StatefulWidget {
  @override
  _BottomPanelStateMobile createState() => _BottomPanelStateMobile();
}

class _BottomPanelStateMobile extends State<BottomPanelMobile> {
...
class MarqueeWidgetMobile extends StatefulWidget {
  final Widget _child;
  ...
  @override
  _MarqueeWidgetStateMobile createState() => _MarqueeWidgetStateMobile();
}

class _MarqueeWidgetStateMobile extends State<MarqueeWidgetMobile> {
