...
class BottomPanelTablet extends StatefulWidget {
  @override
  _BottomPanelStateTablet createState() => _BottomPanelStateTablet();
}

class _BottomPanelStateTablet extends State<BottomPanelTablet> {
...
class MarqueeWidgetTablet extends StatefulWidget {
  final Widget _child;
  ...
  @override
  _MarqueeWidgetStateTablet createState() => _MarqueeWidgetStateTablet();
}

class _MarqueeWidgetStateTablet extends State<MarqueeWidgetTablet> {
