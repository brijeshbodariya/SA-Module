...
import 'package:smartkit/FullApp/FoodMaster/activity/Restaurant/ReviewList.dart';
...
import '../Restaurant/ItemDetail.dart';
    ...
    return Column(children: [
      ...
      Padding(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            GestureDetector(
                onTap: () async {
                  Navigator.push(context, CupertinoPageRoute(builder: (context) => ReviewList(resid: selectedrestaurant.id))).then((value) {
                    setState(() {});
                  });
                },
                child: Row(mainAxisSize: MainAxisSize.min, children: [
