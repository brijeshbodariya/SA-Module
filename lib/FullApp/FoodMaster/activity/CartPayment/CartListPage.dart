...
import 'package:smartkit/FullApp/FoodMaster/helper/new_dialog.dart';
...
class _CartListPageState extends State<CartListPage> {
  ...
  void checkoutProcess() {
    ...
    Navigator.of(context).push(
        CupertinoPageRoute(builder: (context) => PaymentAddressPage(address: widget.address, name: widget.name, phone: widget.phone, timeslot: widget.timeslot, openTime: widget.openTime, closTome: widget.closeTime, mini: widget.mini, id: widget.id2)));
  }
}
