...
import 'package:smartkit/FullApp/FoodMaster/activity/profile/AddNewAddress.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: IntrinsicHeight(
        child: GestureDetector(
          onTap: () {
            Navigator.of(context).pushReplacement(CupertinoPageRoute(builder: (context) => AddNewAddress(address: addresslist)));
          },
