...
import 'package:smartkit/FullApp/FoodMaster/mobile/activity/Order/OrderDetailPageMobile.dart';
...
class OrderListMobile extends StatefulWidget {
  final dynamic restorant;

  const OrderListMobile({Key key, this.restorant}) : super(key: key);
  @override
  _OrderListStateMobile createState() => _OrderListStateMobile();
}

class _OrderListStateMobile extends State<OrderListMobile> {
          ...
          return ButtonClickAnimation(
            onTap: () {
              Navigator.push(
                  context,
                  CupertinoPageRoute(
                      builder: (context) => OrderDetailPageMobile(
                          order: order.id,
