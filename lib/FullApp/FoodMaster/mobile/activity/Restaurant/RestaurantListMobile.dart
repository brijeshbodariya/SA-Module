...
class RestaurantListMobile extends StatefulWidget {
  ...
  @override
  _RestaurantListStateMobile createState() => _RestaurantListStateMobile();
}

class _RestaurantListStateMobile extends State<RestaurantListMobile> {
