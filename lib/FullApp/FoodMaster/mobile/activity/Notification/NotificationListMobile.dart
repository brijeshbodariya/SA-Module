...
import 'NotificationDetailMobile.dart';
...
class NotificationListMobile extends StatefulWidget {
  @override
  _NotificationListStateMobile createState() => _NotificationListStateMobile();
}

class _NotificationListStateMobile extends State<NotificationListMobile> {
        ...
        itemBuilder: (context, index) {
          ...
          return ButtonClickAnimation(
            onTap: () {
              ...
              Navigator.push(context, CupertinoPageRoute(builder: (context) => NotificationDetailActivityMobile()));
            },
            child: Card(
