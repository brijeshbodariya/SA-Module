...
import '../Restaurant/RestaurantDetailMobile.dart';

StreamController<String> favstreamdata;
StreamController<String> favitemstreamdata;

class FavouriteListMobile extends StatefulWidget {
  @override
  _FavouriteListStateMobile createState() => _FavouriteListStateMobile();
}

class _FavouriteListStateMobile extends State<FavouriteListMobile> {
