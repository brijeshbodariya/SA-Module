...
import 'package:smartkit/FullApp/FoodMaster/mobile/helper/googleplaces/flutter_google_places.dart';
import 'package:smartkit/FullApp/FoodMaster/model/Address.dart';

import 'AddressListMobile.dart';

class AddNewAddressMobile extends StatefulWidget {
  final List address;

  const AddNewAddressMobile({Key key, this.address}) : super(key: key);
  @override
  _AddNewAddressStateMobile createState() => _AddNewAddressStateMobile();
}

class _AddNewAddressStateMobile extends State<AddNewAddressMobile> {
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    Navigator.of(context).pushReplacement(CupertinoPageRoute(builder: (context) => AddressListMobile()));
                  },
