...
import 'NotificationDetailTablet.dart';
...
class NotificationListTablet extends StatefulWidget {
  @override
  _NotificationListStateTablet createState() => _NotificationListStateTablet();
}

class _NotificationListStateTablet extends State<NotificationListTablet> {
        ...
        itemBuilder: (context, index) {
          ...
          return ButtonClickAnimation(
            onTap: () {
              ...
              Navigator.push(context, CupertinoPageRoute(builder: (context) => NotificationDetailActivityTablet()));
            },
            child: Card(
