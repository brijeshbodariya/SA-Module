...
class CartListPageTablet extends StatefulWidget {
  ...
  CartListPageTablet(
      ...
      : super(key: key);
  @override
  _CartListPageStateTablet createState() => _CartListPageStateTablet();
}

class _CartListPageStateTablet extends State<CartListPageTablet> {
  ...
  void checkoutProcess() {
    ...
    Navigator.of(context).push(CupertinoPageRoute(
        builder: (context) => PaymentAddressPageTablet(address: widget.address, name: widget.name, phone: widget.phone, timeslot: widget.timeslot, openTime: widget.openTime, closTome: widget.closeTime, mini: widget.mini, id: widget.id2)));
  }
}
