...
import 'package:smartkit/FullApp/FoodMaster/tablet/activity/CartPayment/PaymentAddressPageTablet.dart';
...
import 'package:smartkit/FullApp/FoodMaster/tablet/helper/StripeChargeCardMethod.dart';
import 'package:smartkit/FullApp/FoodMaster/tablet/activity/CartPayment/CartListPageTablet.dart';
import 'package:smartkit/FullApp/FoodMaster/tablet/helper/dialogs.dart';

import 'Order_PlaceTablet.dart';

class PaymentPageTablet extends StatefulWidget {
  final List timeslot;

  const PaymentPageTablet({Key key, this.timeslot}) : super(key: key);
  @override
  _PaymentPageStateTablet createState() => _PaymentPageStateTablet();
}

class _PaymentPageStateTablet extends State<PaymentPageTablet> {
  ...
  Future callPaymentStatus() async {
    Navigator.of(context).pushReplacement(CupertinoPageRoute(builder: (context) => Order_PlaceTablet()));
    setState(() {
      loadingorder = false;
    });
  }
