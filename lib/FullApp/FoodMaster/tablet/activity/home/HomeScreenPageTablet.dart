...
import 'package:smartkit/FullApp/FoodMaster/tablet/activity/Restaurant/RestaurantDetailTablet.dart';
...
class HomeScreenPageTablet extends StatefulWidget {
  _HomeScreenPageStateTablet homestate = new _HomeScreenPageStateTablet();

  @override
  _HomeScreenPageStateTablet createState() => homestate;
}

class _HomeScreenPageStateTablet extends State<HomeScreenPageTablet> {
