...
class ReviewListTablet extends StatefulWidget {
  final int resid;
  ReviewListTablet({
    Key key,
    this.resid,
  ...
  @override
  _ReviewListStateTablet createState() => _ReviewListStateTablet();
}

class _ReviewListStateTablet extends State<ReviewListTablet> {
