...
import 'package:smartkit/FullApp/FoodMaster/tablet/activity/Restaurant/ReviewListTablet.dart';
...
import 'package:smartkit/FullApp/FoodMaster/tablet/helper/new_dialog.dart';
...
import '../home/HomeScreenPageTablet.dart';
import 'RestaurantListTablet.dart';

StreamController<String> resdetailstreamdata;

class RestaurantDetailTablet extends StatefulWidget {
  final bool fromfav;
  final int id;
  const RestaurantDetailTablet({
    Key key,
    this.fromfav,
    this.id,
  }) : super(key: key);
  @override
  _RestaurantDetailStateTablet createState() => _RestaurantDetailStateTablet();
}

class _RestaurantDetailStateTablet extends State<RestaurantDetailTablet> {
  bool isfav = false;
    ...
    return Column(children: [
      ...
      Padding(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            GestureDetector(
                onTap: () async {
                  Navigator.push(context, CupertinoPageRoute(builder: (context) => ReviewListTablet(resid: selectedrestaurant.id))).then((value) {
                    setState(() {});
                  });
                },
                child: Row(mainAxisSize: MainAxisSize.min, children: [
