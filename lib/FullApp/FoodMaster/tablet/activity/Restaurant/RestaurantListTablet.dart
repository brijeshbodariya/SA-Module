...
class RestaurantListTablet extends StatefulWidget {
  final bool fromsearch;
  const RestaurantListTablet({
    Key key,
    this.fromsearch,
  }) : super(key: key);
  @override
  _RestaurantListStateTablet createState() => _RestaurantListStateTablet();
}

class _RestaurantListStateTablet extends State<RestaurantListTablet> {
