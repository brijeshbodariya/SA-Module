...
import 'package:smartkit/FullApp/FoodMaster/tablet/helper/LifecycleEventHandler.dart';
import 'package:smartkit/FullApp/FoodMaster/tablet/helper/StringsRes.dart';
import 'package:smartkit/FullApp/FoodMaster/tablet/helper/flutter_rating_bar.dart';
...
class OrderDetailPageTablet extends StatefulWidget {
  ...
  const OrderDetailPageTablet(
      ...
      : super(key: key);
  @override
  _OrderDetailPageStateTablet createState() => _OrderDetailPageStateTablet();
}

class _OrderDetailPageStateTablet extends State<OrderDetailPageTablet> {
