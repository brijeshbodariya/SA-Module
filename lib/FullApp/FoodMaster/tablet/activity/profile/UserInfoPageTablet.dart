...
import 'package:smartkit/FullApp/FoodMaster/tablet/activity/profile/ChangePasswordTablet.dart';

class UserInfoPageTablet extends StatefulWidget {
  @override
  _UserInfoPageStateTablet createState() => _UserInfoPageStateTablet();
}

class _UserInfoPageStateTablet extends State<UserInfoPageTablet> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: GestureDetector(
                                onTap: () {
                                  Navigator.of(context).push(CupertinoPageRoute(builder: (context) => ChangePasswordTablet()));
                                },
                                child: Text(
