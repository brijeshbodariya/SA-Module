...
import 'package:smartkit/FullApp/FoodMaster/tablet/helper/googleplaces/flutter_google_places.dart';
import 'package:smartkit/FullApp/FoodMaster/model/Address.dart';

import 'AddressListTablet.dart';

class AddNewAddressTablet extends StatefulWidget {
  final List address;

  const AddNewAddressTablet({Key key, this.address}) : super(key: key);
  @override
  _AddNewAddressStateTablet createState() => _AddNewAddressStateTablet();
}

class _AddNewAddressStateTablet extends State<AddNewAddressTablet> {
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    Navigator.of(context).pushReplacement(CupertinoPageRoute(builder: (context) => AddressListTablet()));
                  },
