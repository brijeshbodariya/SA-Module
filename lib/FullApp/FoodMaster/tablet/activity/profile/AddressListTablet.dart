...
import 'package:smartkit/FullApp/FoodMaster/tablet/activity/profile/AddNewAddressTablet.dart';
...
class AddressListTablet extends StatefulWidget {
  final bool fromcart;
  const AddressListTablet({
    Key key,
    this.fromcart,
  }) : super(key: key);
  @override
  _AddressListStateTablet createState() => _AddressListStateTablet();
}

class _AddressListStateTablet extends State<AddressListTablet> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: IntrinsicHeight(
        child: GestureDetector(
          onTap: () {
            Navigator.of(context).pushReplacement(CupertinoPageRoute(builder: (context) => AddNewAddressTablet(address: addresslist)));
          },
