...
import 'package:smartkit/FullApp/FoodMaster/tablet/activity/IntroSliderScreensTablet.dart';
...
class ExplodeViewMain extends StatelessWidget {
  ...
  const ExplodeViewMain({@required this.imagePath, @required this.imagePosFromLeft, @required this.imagePosFromTop});
  ...
  explodeImage() {
    ...
    Future.delayed(Duration(milliseconds: 4000), () {
      ...
      for (int i = 0; i < noOfParticles; i++) {
        ...
        if (i < 21) {
          particles.add(Particle(
              ...
              offsetX: (imageCenterPositionX - imagePositionOffsetX + (i * 0.7)) * 0.1,
          ...
          particles.add(Particle(
              ...
              colors: color.withOpacity(1.0),
              //colors: colors[i].withOpacity(1.0),
              offsetX: (imageCenterPositionX - imagePositionOffsetX + (i * 0.5)) * 0.1,
          ...
          particles.add(Particle(
              ...
              //colors: colors[i].withOpacity(1.0),
              colors: color.withOpacity(1.0),
              offsetX: (imageCenterPositionX - imagePositionOffsetX + (i * 0.9)) * 0.1,
      ...
      Future.delayed(Duration(milliseconds: 1000), () {
        // if (Constant.session.getBoolData(SessionManager.KEY_INTRO_SLIDER)) {
        //  Constant.goToMainPage("splash", context);
        ...
        // } else {
        // Constant.session.setBoolData(SessionManager.KEY_INTRO_SLIDER, true);
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => IntroSliderScreensTablet()),
        );
        // }
      });
    });
        ...
        child: isImage
            ...
            : IntrinsicWidth(
                child: IntrinsicHeight(
                  child: Stack(
                    children: <Widget>[for (Particle particle in particles) particle.startParticleAnimation()],
                  ),
                ),
              ));
  }
