...
import 'package:smartkit/FullApp/FoodMaster/desktop/activity/CartPayment/PaymentPageDesktop.dart';
...
import 'CartListPageDesktop.dart';
...
class PaymentAddressPageDesktop extends StatefulWidget {
  final String address, name, phone, openTime, closTome, mini, id;
  final List timeslot;
  const PaymentAddressPageDesktop({Key key, this.address, this.name, this.phone, this.timeslot, this.openTime, this.closTome, this.mini, this.id}) : super(key: key);
  @override
  _PaymentAddressStateDesktop createState() => _PaymentAddressStateDesktop();
}

class _PaymentAddressStateDesktop extends State<PaymentAddressPageDesktop> {
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.of(context).push(CupertinoPageRoute(
                  builder: (context) => AddressListDesktop(
                        fromcart: true,
                      )));
            },
          )
  ...
  Future<void> payProcees() async {
    ...
    Navigator.of(context).push(CupertinoPageRoute(builder: (context) => PaymentPageDesktop(timeslot: widget.timeslot)));
  }
}
