...
import '../Restaurant/RestaurantDetailDesktop.dart';

StreamController<String> favstreamdata;
StreamController<String> favitemstreamdata;

class FavouriteListDesktop extends StatefulWidget {
  @override
  _FavouriteListStateDesktop createState() => _FavouriteListStateDesktop();
}

class _FavouriteListStateDesktop extends State<FavouriteListDesktop> {
