...
import 'package:smartkit/FullApp/FoodMaster/desktop/helper/googleplaces/flutter_google_places.dart';
import 'package:smartkit/FullApp/FoodMaster/model/Address.dart';

import 'AddressListDesktop.dart';

class AddNewAddressDesktop extends StatefulWidget {
  final List address;

  const AddNewAddressDesktop({Key key, this.address}) : super(key: key);
  @override
  _AddNewAddressStateDesktop createState() => _AddNewAddressStateDesktop();
}

class _AddNewAddressStateDesktop extends State<AddNewAddressDesktop> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          body: Center(
            child: SizedBox(width:600,height:650,
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () async {
                            ...
                            Navigator.of(context).pushReplacement(CupertinoPageRoute(builder: (context) => AddressListDesktop()));
                          },
