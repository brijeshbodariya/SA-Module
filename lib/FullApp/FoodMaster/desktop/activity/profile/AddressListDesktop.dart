...
import 'package:smartkit/FullApp/FoodMaster/desktop/activity/profile/AddNewAddressDesktop.dart';
...
class AddressListDesktop extends StatefulWidget {
  final bool fromcart;
  const AddressListDesktop({
    Key key,
    this.fromcart,
  }) : super(key: key);
  @override
  _AddressListStateDesktop createState() => _AddressListStateDesktop();
}

class _AddressListStateDesktop extends State<AddressListDesktop> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: IntrinsicHeight(
        child: GestureDetector(
          onTap: () {
            Navigator.of(context).pushReplacement(CupertinoPageRoute(builder: (context) => AddNewAddressDesktop(address: addresslist)));
          },
