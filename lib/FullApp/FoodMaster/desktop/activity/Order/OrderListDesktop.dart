...
import 'package:smartkit/FullApp/FoodMaster/desktop/activity/Order/OrderDetailPageDesktop.dart';
...
class OrderListDesktop extends StatefulWidget {
  ...
  const OrderListDesktop({Key key, this.restorant}) : super(key: key);
  @override
  _OrderListStateDesktop createState() => _OrderListStateDesktop();
}

class _OrderListStateDesktop extends State<OrderListDesktop> {
          ...
          return ButtonClickAnimation(
            onTap: () {
              Navigator.push(
                  context,
                  CupertinoPageRoute(
                      builder: (context) => OrderDetailPageDesktop(
                          order: order.id,
