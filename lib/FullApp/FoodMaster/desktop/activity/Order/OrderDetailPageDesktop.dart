...
import 'package:smartkit/FullApp/FoodMaster/desktop/helper/LifecycleEventHandler.dart';
...
class OrderDetailPageDesktop extends StatefulWidget {
  ...
  const OrderDetailPageDesktop(
      ...
      : super(key: key);
  @override
  _OrderDetailPageStateDesktop createState() => _OrderDetailPageStateDesktop();
}

class _OrderDetailPageStateDesktop extends State<OrderDetailPageDesktop> {
